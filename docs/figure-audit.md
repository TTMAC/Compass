...
- **Confirmed live errors still to fix (Phase 2, high-confidence, web-sourced):** `ra-5-2` R232bn irregular → ~R63bn (2022/23); `hd-5-2` emigrants ~900k → ~1M; `hd-5-3` Costa Rica renewables 99% → ~90% (2023–24); `hd-4-3` informal 17–18% → ~19.5% + caveat; `ra-4-3` refuse 60% → ~66%; `ra-4-3` potholes "67% increase" → "67% formed in 5 yrs"; `hd-5-2` debt-service year-label 2024/25 → 2023/24.
- **Source-or-soften (couldn't web-confirm):** `hd-5-2` doctor-training R3–4M (sourced ~R1.3M 2015); `ra-4-4` R650k/R970k engineer salaries; `ra-4-4` Buffalo City 80-month vacancy; `ra-4-4` AGSA R31.79bn/R28.72bn/446-MI/7-disclaimer detail.
