...
- **Owner-source-resolved items:** `ss-2-4` femicide (SAMRC/UN Women, commit `da9b8f1`); `2-3` Eskom municipal debt anchored to Treasury R56.3bn Dec-2022 (`11e8bbe`); `eg-4-2` manufacturing employment → Stats SA formal survey (`2244783`); `1-3` Section 139 → PBO May-2025 figure (commit pending).
- **Remaining open:** `2-3` "consumer debt to municipalities >R300bn (mid-2024)" — needs a dated Treasury S71 source; `3-3` "more than 70 municipalities under S139 since democracy" — cumulative figure unverified (plausible); the EG 🕒 confirm-then-edit list (citrus #1, STEM-grad counts, German apprentices, R&D %) — value changes still pending; the broad 🕒 year-label list (PIRLS/TIMSS standardisation, "(2024/25)" tags) not yet done.
